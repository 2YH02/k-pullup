  ...
  return (
    <SideMain headerTitle="소셜" withNav fullHeight deviceType={deviceType} bodyStyle="pb-0">
        ...
        <div className="flex w-full gap-3 overflow-x-scroll overflow-y-hidden px-1 py-1 scrollbar-hidden">
          {Array.from({ length: 4 }).map((_, index) => (
            <div
              ...
              className="group flex h-22 w-58 shrink-0 items-center gap-3 rounded-2xl border border-border bg-white dark:bg-black-light px-3 py-2.5 text-left"
            >
      ...
      <Section>
        ...
        <div className="mb-3 inline-flex rounded-full border border-border bg-white dark:bg-black-light p-1 dark:border-grey-dark">
