  ...
  return (
    <SideMain headerTitle="설정" fullHeight hasBackButton deviceType={deviceType}>
      <section className="mb-4 px-6">
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-surface/80 dark:border-grey-dark dark:bg-black">
      ...
      <section className="mb-4 px-6">
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-surface/80 dark:border-grey-dark dark:bg-black">
          <div className="flex min-h-12 items-center justify-between border-b border-border px-3 py-2.5 dark:border-grey-dark">
