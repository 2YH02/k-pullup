    ...
    >
      <Section className="mt-8">
        <div className="mx-auto flex max-w-sm flex-col items-center text-center motion-safe:animate-page-enter">
          <div className="relative mb-5 flex h-14 w-14 items-center justify-center rounded-full border border-primary/20 bg-primary-subtle dark:border-primary-dark/40 dark:bg-primary-dark/20">
