    ...
    <footer className="mt-12 w-full border-t border-border bg-side-main px-4 py-8 dark:border-white/10 dark:bg-black">
      <div className="mx-auto flex max-w-(--breakpoint-xl) flex-col items-center gap-3 text-sm">
        <Link
          ...
          target="_blank"
          className="rounded-full border border-border px-4 py-1.5 text-text-on-surface transition-colors web:hover:bg-primary-subtle active:bg-primary/12 dark:border-white/15 dark:text-grey-light"
        >
          커피 한잔 후원하기
        </Link>
